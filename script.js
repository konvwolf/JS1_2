    ...
    switch (arithmetics) {
        ...
        case "/":
            ...
            if (Number.isInteger(divide)) { // если число не имеет знаков после запятой, вывожу результат
                ...
                return (arg1 / arg2).toFixed(2); // округляю до двух знаков после запятой
            }
    }
}
...
function deposit(num) {
    ...
    if (ending == 0 || ending == 5 || ending == 6 || ending == 7 || ending == 8 || ending == 9) {
        // 0, 5, 6, 7, 8, 9 или заканчивается на эти цифры
        return "ей";
